...
public abstract class BattleState : State 
{
	...
	protected override void AddListeners ()
	{
		if (driver == null || driver.Current == Drivers.Human)
		{
            ...
            InputController.moveButtonEvent += MoveButton;
            InputController.actionButtonEvent += ActionButton;
		}
	}
    ...
    protected virtual void MoveButton(object sender, InfoEventArgs<Point>e)
    {

    }

    protected virtual void ActionButton(object sender, InfoEventArgs<int> e)
    {
